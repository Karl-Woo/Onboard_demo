import svgPaths from "./svg-nb69hp7zuw";
...
import imgRectangle1859 from "figma:asset/7b2be2aebbcbee5af3d67cb822945b7b62fe9d3c.png";
import { imgGroup1, imgGroup, imgVector } from "./svg-oamxc";
...
function Headline() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center not-italic relative shrink-0 text-center w-[1063px]" data-name="headline">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[0.885] min-w-full relative shrink-0 text-[92px] text-white uppercase w-[min-content] whitespace-pre-wrap">
        {`a clover for every `}
        <br aria-hidden="true" />
        small business
      </p>
      <div className="flex flex-col font-['Graphik:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-[#ededed] text-[16px] w-[629px]">
...
function Group2() {
  return (
    <div className="absolute bottom-1/4 left-[21.43%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-6.857px_-8px] mask-size-[32px_32px] right-[21.43%] top-1/4" style={{ maskImage: `url('${imgGroup1}')` }}>
      <div className="absolute inset-[-6.25%_-7.73%_-6.25%_-5.46%]">
...
function Header() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-start justify-between min-h-px min-w-px relative" data-name="header">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#333] text-[56px] uppercase w-[632px]">Keep things flowing with the all-in-one restaurant POS</p>
      <Content1 />
    </div>
  );
}
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-[320px] relative" data-name="Card/Vertical">
        <div className="aspect-[343/420] relative rounded-[16px] shrink-0 w-full" data-name="Card/Vertical">
          <div className="content-stretch flex flex-col gap-[10px] items-center justify-end overflow-clip relative rounded-[inherit] size-full">
            ...
            <div className="absolute h-[39px] left-0 top-[377px] w-[340px]" data-name="Tag">
...
function Frame40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[56px] text-white uppercase w-full">Restaurant-grade hardware that hustles as hard as you do</p>
    </div>
  );
}
...
function Info1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 text-white w-[376px]" data-name="info">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] min-w-full relative shrink-0 text-[40px] uppercase w-[min-content]">CLOVER Flex</p>
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[16px] w-[376px]">
...
function Content2() {
  return (
    <div className="bg-[#b6fb6f] content-stretch flex flex-col items-center py-[4px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-full" data-name="content">
      <p className="font-['Graphik:Medium',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#040] text-[16px] text-center whitespace-nowrap">Flex</p>
    </div>
  );
}
...
function Headline5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Headline">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#040] text-[56px] text-center uppercase w-full">Run the numbers</p>
    </div>
  );
}
...
function Copy4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="copy">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.1] relative shrink-0 text-[#040] text-[18px] w-full">Devices in market</p>
      <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] relative shrink-0 text-[#4b4b4b] text-[16px] w-full">{`Used by small businesses across restaurants, retail, and the service industry. `}</p>
    </div>
  );
}
...
function Copy5() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="copy">
      ...
      <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] relative shrink-0 text-[#4b4b4b] text-[16px] w-full">Named “Best Overall Commerce Platform” at the 2024 FinTech Breakthrough Awards.</p>
    </div>
  );
}
...
function Copy6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="copy">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.1] relative shrink-0 text-[#040] text-[18px] w-full">Annual transactions</p>
      <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] relative shrink-0 text-[#4b4b4b] text-[16px] w-full">A testament to Clover’s robust and reliable processing capabilities.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full" data-name="Stats">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-[156px] items-start justify-center min-h-px min-w-px not-italic relative text-center" data-name="Module/Stat/Card">
        <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[0.885] relative shrink-0 text-[#040] text-[92px] uppercase w-full">4M+</p>
        <Copy4 />
      </div>
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-[156px] items-start justify-center min-h-px min-w-px not-italic relative text-center" data-name="Module/Stat/Card">
        <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[0.885] relative shrink-0 text-[#040] text-[92px] uppercase w-full">#1</p>
        <Copy5 />
      </div>
      <div className="flex h-0 items-center justify-center relative self-center shrink-0 w-0" style={{ containerType: "size", "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none w-[100cqh]">
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-[156px] items-start justify-center min-h-px min-w-px not-italic relative text-center" data-name="Module/Stat/Card">
        <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[0.885] relative shrink-0 text-[#040] text-[92px] uppercase w-full">10B+</p>
        <Copy6 />
      </div>
    </div>
  );
...
function Blur() {
  return <div className="-translate-y-1/2 absolute backdrop-blur-[12px] h-[783px] left-[-0.44px] top-1/2 w-[1392px]" data-name="Blur" />;
}
...
function QuoteBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[122px] items-start relative shrink-0 w-[622px]" data-name="Quote Block">
      <QuotationMarks />
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic overflow-hidden relative shrink-0 text-[56px] text-ellipsis text-white uppercase w-[622px]">I consider clover our third arm ... allowing us to focus on business not paperwork.</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start justify-center leading-[1.3] min-h-px min-w-px not-italic relative text-white whitespace-nowrap">
      <p className="font-['Graphik:Medium',sans-serif] relative shrink-0 text-[16px]">Robert Cucco</p>
      <p className="font-['Graphik:Regular',sans-serif] relative shrink-0 text-[14px]">Table 87</p>
    </div>
  );
}
...
function Testimonials() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col h-[783px] items-start justify-between left-1/2 overflow-clip p-[56px] rounded-[16px] top-[24px] w-[1392px]" data-name="Testimonials">
...
function Content3() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[524px]" data-name="content">
      <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#4b4b4b] text-[16px] w-[min-content]">Drive revenue and deliver more to customers with commission-free online ordering, delivery management, and easy integration with third-party delivery apps.</p>
      <div className="bg-[#b6fb6f] h-[56px] min-w-[200px] relative rounded-[8px] shrink-0" data-name="Button">
        <div className="content-stretch flex h-full items-center justify-center min-w-[inherit] overflow-clip relative rounded-[inherit]">
          <Bg4 />
          <Button4 />
...
function Header1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-start justify-between min-h-px min-w-px relative" data-name="header">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#333] text-[56px] uppercase w-[632px]">All of your online orders, in one place</p>
      <Content3 />
    </div>
  );
}
...
function Copy7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Copy">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[12px] relative w-full">
        <Headline6 />
        <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#4b4b4b] text-[14px] w-[min-content]">Connect to leading online ordering platforms and streamline your sales processes for maximum efficiency.</p>
      </div>
    </div>
  );
}
...
function Copy8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Copy">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[12px] relative w-full">
        <Headline7 />
        <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#4b4b4b] text-[14px] w-[min-content]">Add online ordering to your website with zero hassle for integrated menu management, order processing, and inventory tracking.</p>
      </div>
    </div>
  );
}
...
function Copy9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Copy">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[12px] relative w-full">
        <Headline8 />
        <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#4b4b4b] text-[14px] w-[min-content]">Power smooth transactions with a secure, customizable, and mobile-friendly checkout page.</p>
      </div>
    </div>
  );
}
...
function Copy10() {
  return (
    <div className="relative shrink-0 w-full" data-name="Copy">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[12px] relative w-full">
        <Headline9 />
        <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#4b4b4b] text-[14px] w-[min-content]">{`Streamline operations with a single system for online ordering, menu management, and order processing. `}</p>
      </div>
    </div>
  );
}
...
function Blur1() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute backdrop-blur-[12px] h-[634px] left-1/2 top-[calc(50%+27px)] w-[1392px]" data-name="Blur" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.01) 0%, rgba(255, 255, 255, 0.01) 100%)" }} />;
}
...
function Copy11() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 text-white w-[524px]" data-name="copy">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] relative shrink-0 text-[56px] uppercase w-full">{`Go premium with clover hospitality `}</p>
      <p className="font-['Graphik:Regular',sans-serif] leading-[1.3] relative shrink-0 text-[16px] w-full">{`Clover Hospitality delivers an upgraded POS solution for bars and restaurants with extra features like advanced table management, enhanced customer profiles, and omnichannel capabilities. `}</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[24px]" data-name="Utilitarian icons">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Utilitarian icons">
          <mask height="24" id="mask0_6_8972" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_6_8972)">
            <g id="Group 1">
...
function Driver() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-center relative rounded-[16px] shrink-0" data-name="Driver">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#040] text-[24px] tracking-[0.24px] uppercase whitespace-nowrap">SHOP Hospitality</p>
      <UtilitarianIcons />
    </div>
  );
}
...
function UtilitarianIcons7() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Utilitarian icons">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Utilitarian icons">
          <mask height="24" id="mask0_6_8984" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_6_8984)">
            <g id="Group 1">
              <path d={svgPaths.p10fe100} id="line-3" stroke="var(--stroke-0, #004400)" strokeLinecap="square" strokeWidth="2" />
              <path d="M17.2983 12.0001H4.44115" id="Vector 1" stroke="var(--stroke-0, #004400)" strokeLinecap="square" strokeLinejoin="bevel" strokeWidth="2" />
            </g>
...
function Title() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[516px]" data-name="Title">
      <p className="font-['PP_Formula:Condensed_Black',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#333] text-[56px] uppercase w-[524px]">Frequently Asked Questions</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Answer">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pr-[32px] relative w-full">
          <p className="flex-[1_0_0] font-['Graphik:Regular',sans-serif] leading-[1.3] min-h-px min-w-px not-italic relative text-[#4b4b4b] text-[16px]">Clover is a small business point of sale (POS) company that provides a range of hardware and software solutions to help small businesses manage their transactions, inventory, and more.</p>
        </div>
      </div>
    </div>
  );
...
function Container() {
  return (
    <div className="bg-white max-w-[1440px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
...
function Content5() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[1440px] relative shrink-0 w-full" data-name="Content">
...
function Content6() {
  return (
    <div className="content-stretch flex flex-col gap-[56px] items-center max-w-[1440px] not-italic relative shrink-0 text-[#333] w-full" data-name="Content">
      <LinksRow />
      <LinksRow1 />
    </div>
  );
...
function CountrySelector() {
  return (
    <div className="content-stretch flex gap-[8px] h-[23px] items-center relative shrink-0" data-name="Country Selector">
      ...
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4b4b4b] text-[14px] text-right whitespace-nowrap">
...
function Content7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between max-w-[1440px] min-h-px min-w-px relative" data-name="Content">
      <CountrySelector />
      <CountrySelector1 />
      <SocialIcons />
    </div>
...
function Left() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Graphik:Regular',sans-serif] h-full items-start justify-between max-w-[728px] min-h-px min-w-px relative text-[#333]" data-name="Left">
...
function Content8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between max-w-[1440px] min-h-px min-w-px not-italic relative self-stretch text-[14px]" data-name="Content">
      <Left />
      <Links1 />
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Footnote">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[80px] py-[48px] relative w-full">
          <div className="font-['Graphik:Regular',sans-serif] leading-[0] max-w-[1440px] not-italic relative shrink-0 text-[#333] text-[14px] w-full whitespace-pre-wrap">
...
function Products() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="products">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">{`Food & beverage`}</p>
    </div>
  );
}
...
function Resources1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="resources">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Services</p>
    </div>
  );
}
...
function Products1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="products">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Retail</p>
    </div>
  );
}
...
function Resources2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="resources">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Products</p>
    </div>
  );
}
...
function Resources3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="resources">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Resources</p>
    </div>
  );
}
...
function Pricing() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="pricing">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Log In</p>
    </div>
  );
}
...
function Pricing1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="pricing">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Support</p>
    </div>
  );
}
...
function Pricing2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="pricing">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Pricing</p>
    </div>
  );
}
...
function Pricing3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="pricing">
      <p className="font-['Altform:SemiBold',sans-serif] leading-[1.57] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">{`Shop `}</p>
    </div>
  );
}
...
function HomePageRestaurantsDesktop() {
  return (
    <div className="absolute bg-[#ededed] content-stretch flex flex-col items-start left-0 overflow-x-clip overflow-y-auto top-0 w-[1440px]" data-name="Home_Page_Restaurants_Desktop">
      <div className="content-stretch flex flex-col h-[900px] items-center px-[80px] py-[160px] relative shrink-0 w-[1440px]" data-name="Module/LandingPageHero">
        <div className="absolute inset-0 overflow-hidden">
          <video autoPlay className="absolute h-[136.78%] left-[-19.75%] max-w-none top-[-33.44%] w-[141.17%]" controlsList="nodownload" loop playsInline>
            <source src="/_videos/v1/355d8ffad00c129bf3dc22f74057c32ea086dabf" />
          </video>
        </div>
        <Content />
      </div>
      <div className="bg-[#b6fb6f] content-stretch flex h-[64px] items-center justify-between px-[80px] py-[8px] relative shrink-0 w-[1440px]" data-name="Navigation/Secondary">
        ...
        <TabTabs />
        <div className="backdrop-blur-[2px] content-stretch flex gap-[10px] items-center justify-center p-[4px] relative shrink-0" data-name="Navigation/Callout">
          <Info />
          <div className="relative shrink-0 size-[24px]" data-name="Utilitarian icons">
            <Group2 />
          </div>
      ...
      <div className="bg-[#ededed] content-stretch flex flex-col gap-[40px] items-start justify-center overflow-clip pb-[80px] pt-[120px] px-[24px] relative shrink-0 w-[1440px]" data-name="Module/RecircCards">
        <TopContent />
        <Cards />
      </div>
      ...
      <div className="bg-[#b6fb6f] h-[831px] relative shrink-0 w-[1440px]" data-name="Module/TestimonialShowcase">
        <Testimonials />
      </div>
      <div className="bg-[#ededed] content-stretch flex flex-col gap-[40px] items-start justify-center overflow-clip pb-[80px] pt-[120px] px-[24px] relative shrink-0 w-[1440px]" data-name="Module/RecircCards">
        <TopContent1 />
      ...
      <div className="content-stretch flex flex-col items-start overflow-clip p-[24px] relative rounded-[16px] shrink-0 w-[1440px]" data-name="MarqueeHighlight">
        <Content4 />
        <Ticker />
      </div>
      <div className="content-stretch flex flex-col items-center overflow-clip pb-[24px] px-[24px] relative shrink-0 w-[1440px]" data-name="Module/FAQ">
        <Container />
      </div>
      ...
      <div className="absolute content-stretch flex h-[80px] items-center justify-between left-0 px-[80px] top-0 w-[1440px]" data-name="Navigation/Primary">
...
function Frame43() {
  return (
    <div className="content-stretch flex gap-[4px] items-center overflow-clip relative shrink-0">
      ...
      <div className="flex flex-col font-['Graphik:medium',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[18px] text-center text-ellipsis text-white whitespace-nowrap">
    ...
    <div className="min-h-[48px] relative shrink-0 w-full" data-name="Contents" style={{ backgroundImage: "linear-gradient(-5.39702deg, rgb(16, 54, 79) 23.592%, rgb(22, 73, 75) 98.517%)" }}>
      <div className="flex flex-row items-center min-h-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center min-h-[inherit] pl-[16px] pr-[56px] py-[16px] relative w-full">
          <div className="content-stretch flex items-start overflow-clip relative rounded-[8px] shrink-0" data-name="Switch">
    ...
    <div className="relative shrink-0 w-full" data-name="AI assistant">
      <div className="flex flex-col items-end size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-end p-[16px] relative w-full">
          <div className="font-['Graphik:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[0px] text-black w-[min-content]">
            <p className="mb-0 text-[16px]">
              <span className="leading-[24px]">{`Hi! I'm here to help you `}</span>
              <span className="font-['Graphik:Medium',sans-serif] leading-[24px] not-italic">find the right Clover setup</span>
              <span className="leading-[24px]">.</span>
            </p>
            <p className="leading-[24px] text-[16px]">What’s your business name and where are you located (City, State)?</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full">
      <div className="bg-[#c7c7c7] content-stretch flex flex-col items-end px-[16px] py-[12px] relative rounded-bl-[24px] rounded-tl-[24px] rounded-tr-[24px] shrink-0 w-[199px]" data-name="ChatUserMessage">
        <p className="font-['Graphik:regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-right w-full">Moe’s Coffee, NYC, NY</p>
      </div>
    </div>
  );
}
...
function AiAssistant1() {
  return (
    <div className="relative shrink-0 w-full" data-name="AI assistant">
      <div className="flex flex-col items-end size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-end p-[16px] relative w-full">
          <p className="font-['Graphik:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[0px] text-black w-[min-content]">
            <span className="leading-[24px] text-[16px]">{`I’ve found multiple `}</span>
            <span className="font-['Graphik:Medium',sans-serif] leading-[24px] text-[16px]">Moe’s coffee</span>
            <span className="leading-[24px] text-[16px]">{` in `}</span>
            <span className="font-['Graphik:Medium',sans-serif] leading-[24px] text-[16px]">NYC, NY</span>
            <span className="leading-[24px] text-[16px]">. Which one is yours?</span>
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative w-full">
      <div className="flex-[1_0_0] h-full min-h-px min-w-px relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[186.97%] left-0 max-w-none top-[-0.23%] w-full" src={imgRectangle1859} />
        </div>
      </div>
    </div>
  );
...
function DateContainer() {
  return (
    <div className="content-stretch flex flex-col h-[180px] items-start justify-center overflow-clip relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-[343px]" data-name="Date Container" style={{ backgroundImage: "linear-gradient(-63.8515deg, rgb(22, 90, 0) 13.54%, rgb(32, 128, 0) 84.584%)" }}>
      <Frame31 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute inset-[8.33%]" data-name="frame">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[18px] left-1/2 top-1/2 w-[18.002px]" data-name="vector">
        <div className="absolute inset-[-4.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5018 19.5">
            <path d={svgPaths.p9547500} fill="var(--fill-0, #FFD100)" id="vector" stroke="var(--stroke-0, #FFD100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="absolute inset-[8.33%]" data-name="frame">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[18px] left-1/2 top-1/2 w-[18.002px]" data-name="vector">
        <div className="absolute inset-[-4.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5018 19.5">
            <path d={svgPaths.p9547500} id="vector" stroke="var(--stroke-0, #FFD100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame44() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Frame46 />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">(124 reviews)</p>
      </div>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="absolute inset-[8.33%]" data-name="frame">
      <div className="absolute h-[18px] left-[4px] top-px w-[12px]" data-name="vector">
        <div className="absolute inset-[-4.17%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.4998 19.5">
            <g id="vector">
              <path d={svgPaths.pb28ae00} stroke="var(--stroke-0, #5A5A5A)" strokeWidth="1.5" />
              <path d={svgPaths.p1aac0100} stroke="var(--stroke-0, #5A5A5A)" strokeWidth="1.5" />
            </g>
          </svg>
        </div>
      </div>
...
function Frame47() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">421 Broadway, New York, NY 10013</p>
      </div>
    </div>
  );
}

function DateAndTimeTextContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-full" data-name="Date and Time Text Container">
      <div className="flex flex-col font-['Graphik:Semibold',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">
        <p className="leading-[32px]">Moe’s coffee - Manhattan</p>
      </div>
      <Frame44 />
      <Frame47 />
    </div>
...
function DateContainer1() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-center justify-center px-[24px] py-[20px] relative rounded-bl-[16px] rounded-br-[16px] shrink-0 w-[343px]" data-name="Date Container">
      <DateAndTimeTextContainer />
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Frame49 />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">(15 reviews)</p>
      </div>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">421 Broadway, Queens, NY 10013</p>
      </div>
    </div>
  );
}

function DateAndTimeTextContainer1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-full" data-name="Date and Time Text Container">
      <div className="flex flex-col font-['Graphik:Semibold',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">
        <p className="leading-[32px]">Moe’s coffee - Queens</p>
      </div>
      <Frame48 />
      <Frame50 />
    </div>
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Frame52 />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">(34 reviews)</p>
      </div>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">421 Broadway, Brooklyn, NY 10013</p>
      </div>
    </div>
  );
}

function DateAndTimeTextContainer2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-full" data-name="Date and Time Text Container">
      <div className="flex flex-col font-['Graphik:Semibold',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[24px] text-black w-[min-content]">
        <p className="leading-[32px]">Moe’s coffee - Brooklyn</p>
      </div>
      <Frame51 />
      <Frame53 />
    </div>
...
function HScroll() {
  return (
    <div className="relative rounded-[24px] shrink-0 w-full" data-name="HScroll">
      <div className="content-stretch flex flex-col items-start p-[4px] relative w-full">
        <div className="bg-[#bbb] h-[12px] rounded-[16px] shrink-0 w-[323.636px]" data-name="Bar" />
      </div>
    </div>
  );
}
...
function MessageContainer() {
  return (
    <div className="bg-[#f5f5f5] flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Message container">
      <div className="overflow-clip rounded-[inherit] size-full">
    ...
    <div className="bg-[#f5f5f5] flex-[1_0_0] h-[48px] min-h-px min-w-px relative rounded-[8px]" data-name="Message Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center justify-center p-[12px] relative size-full">
          <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a5a5a] text-[16px] w-full">
            <p className="leading-[24px]">Type your message...</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[17.481px] left-1/2 top-1/2 w-[17.99px]" data-name="vector">
        <div className="absolute inset-[-4.29%_-4.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.4897 18.9813">
            <path d={svgPaths.p3a38a900} id="vector" stroke="var(--stroke-0, #228800)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function ButtonGroup() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center p-[8px] relative shrink-0 size-[48px]" data-name="Button Group">
      <div className="content-stretch flex items-start relative rounded-[8px] shrink-0" data-name="Send">
...
function Chat() {
  return (
    <div className="absolute content-stretch flex flex-col h-[960px] items-start left-[836px] overflow-clip rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.12)] top-[32px] w-[572px]" data-name="Chat">
      <TopAppBar />
      <MessageContainer />
      <ChatMessageField />
    </div>
