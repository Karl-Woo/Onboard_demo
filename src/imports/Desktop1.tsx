import svgPaths from "./svg-zbgk4xnzfr";
...
import { imgGroup1, imgGroup, imgVector } from "./svg-o3i4s";
    ...
    <div className="relative shrink-0 size-[24px]" data-name="Utilitarian icons">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Utilitarian icons">
          <mask height="24" id="mask0_3_9492" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_3_9492)">
            <g id="Group 1">
...
function UtilitarianIcons7() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Utilitarian icons">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Utilitarian icons">
          <mask height="24" id="mask0_3_9474" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_3_9474)">
            <g id="Group 1">
              <path d={svgPaths.p10fe100} id="line-3" stroke="var(--stroke-0, #004400)" strokeLinecap="square" strokeWidth="2" />
              <path d="M17.2983 12.0001H4.44115" id="Vector 1" stroke="var(--stroke-0, #004400)" strokeLinecap="square" strokeLinejoin="bevel" strokeWidth="2" />
            </g>
...
function HomePageRestaurantsDesktop() {
  return (
    <div className="absolute bg-[#ededed] content-stretch flex flex-col items-start left-0 overflow-x-clip overflow-y-auto top-0 w-[1440px]" data-name="Home_Page_Restaurants_Desktop">
      ...
      <div className="bg-[#b6fb6f] content-stretch flex gap-[24px] h-[64px] items-center px-[80px] py-[8px] relative shrink-0 w-[1440px]" data-name="Navigation/Secondary">
    ...
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="frame">
      <div className="absolute inset-[-3.75%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.5 21.5">
          <g id="frame">
            <g id="vector">
              <path d={svgPaths.p1c200c00} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d={svgPaths.p2acfdd00} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </g>
          </g>
        </svg>
      </div>
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop - 1">
      ...
      <div className="absolute content-stretch flex gap-[8px] items-center justify-center left-[1053px] min-w-[100px] overflow-clip px-[16px] py-[12px] rounded-[8px] top-[944px]" data-name="Button" style={{ backgroundImage: "linear-gradient(-6.96271deg, rgb(16, 54, 79) 23.592%, rgb(22, 73, 75) 98.517%)" }}>
